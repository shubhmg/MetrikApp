...
import { createPartySchema, updatePartySchema, listPartySchema, getPartyLedgerSchema } from './party.validation.js';
...
router.get('/:id/ledger', requirePermission('party:read'), validate(getPartyLedgerSchema), partyController.getLedger);
